...
$extra_query = "SELECT id, title FROM $table_extras WHERE active = 1;";
        ...
        <div class="joeee-booking-room-modal-form-content">
            ...
            <form id="joeee-roombooking-room-form" action="">
                ...
                <div class="joeee-booking-room-form-control">
                    ...
                    <input type="text" placeholder="<?php esc_attr_e('Room Number', 'joeee-booking')?>" id="joeee-booking-room-roomnumber" data-cy="room-roomnumber">
                ...
                <div class="joeee-booking-room-form-control">
                    ...
                    <input type="text" placeholder="<?php esc_attr_e('Floor Number', 'joeee-booking')?>" id="joeee-booking-room-floornumber" data-cy="room-floornumber">
                    <i class="dashicons dashicons-yes-alt"></i>
                    <i class="dashicons dashicons-warning"></i>
                    <small>Error message</small>
                </div>
                <div class="joeee-booking-room-form-control">
                    ...
                    <input type="number" placeholder="<?php esc_attr_e('Adults', 'joeee-booking')?>" id="joeee-booking-room-adults" data-cy="room-adults">
                    <i class="dashicons dashicons-yes-alt"></i>
                    <i class="dashicons dashicons-warning"></i>
                    <small>Error message</small>
                </div>
                <div class="joeee-booking-room-form-control">
                    ...
                    <input type="number" placeholder="<?php esc_attr_e('Kids', 'joeee-booking')?>" id="joeee-booking-room-kids" data-cy="room-kids">
                    <i class="dashicons dashicons-yes-alt"></i>
                    <i class="dashicons dashicons-warning"></i>
                    <small>Error message</small>
                </div>
                <div class="joeee-booking-room-form-control">
                    ...
                    <input type="text" placeholder="<?php esc_attr_e('Price', 'joeee-booking')?>" id="joeee-booking-room-price" data-cy="room-price">
                    <i class="dashicons dashicons-yes-alt"></i>
                    <i class="dashicons dashicons-warning"></i>
                    <small>Error message</small>
                </div>
                ...
                <div class="joeee-booking-room-form-check">
                    <input type="checkbox" name="joeee-booking-room-active" id="joeee-booking-room-active" value="on" data-cy="room-active">
                    <label for="room-active"><?php _e("Active", "joeee-booking")?></label>
                </div>
                <input type="submit" value="<?php esc_attr_e('Save', 'joeee-booking')?>" id="joeee-booking-room-submit" class="button-submit" data-cy="room-submit">
                <input type="submit" value="<?php esc_attr_e('Save', 'joeee-booking')?>" id="joeee-booking-room-form-submit-modify" class="button-submit" data-cy="room-submit-modify">
                <button class="joeee-booking-room-cancel-btn button-cancel" data-cy="room-cancel-btn"><?php _e("Cancel", "joeee-booking")?></button>
                <button class="joeee-booking-room-delete-btn button-delete" data-cy="room-delete-btn"><?php _e("Delete room", "joeee-booking")?></button>
            </form>
        ...
        <div class="joeee-booking-reservation-modal-form-content-left">
            ...
            <form id="joeee-booking-reservation-form" action="">
                ...
                <div class="joeee-booking-reservation-form-control">
                    ...
                    <input type="date" name="reservationArrival" id="joeee-booking-reservation-arrival" data-cy="reservation-arrival">
                    <i class="dashicons dashicons-yes-alt"></i>
                    <i class="dashicons dashicons-warning"></i>
                    <small>Error message</small>
                </div>
                <div class="joeee-booking-reservation-form-control">
                    ...
                    <input type="date" name="reservationDeparture" placeholder="<?php esc_attr_e('Departure', 'joeee-booking')?>" id="joeee-booking-reservation-departure" data-cy="reservation-departure">
                    <i class="dashicons dashicons-yes-alt"></i>
                    <i class="dashicons dashicons-warning"></i>
                    <small>Error message</small>
                </div>
                <div class="joeee-booking-reservation-form-control">
                    ...
                    <input type="number" name="reservationPersons" min="1" value="1" placeholder="<?php esc_attr_e('Adults', 'joeee-booking')?>" id="joeee-booking-reservation-persons" data-cy="reservation-adults">
                    <i class="dashicons dashicons-yes-alt"></i>
                    <i class="dashicons dashicons-warning"></i>
                    <small>Error message</small>
                </div>
                <div class="joeee-booking-reservation-form-control">
                    ...
                    <input type="number" name="reservationKids" min="0" value="0" placeholder="<?php esc_attr_e('Kids', 'joeee-booking')?>" id="joeee-booking-reservation-kids" data-cy="reservation-kids">
                    <i class="dashicons dashicons-yes-alt"></i>
                    <i class="dashicons dashicons-warning"></i>
                    <small>Error message</small>
                </div>
...
?>
                <div class="joeee-booking-reservation-form-control">
                    ...
                    <input type="email" name="reservationEmail" placeholder="<?php esc_attr_e('E-Mail', 'joeee-booking')?>" id="joeee-booking-reservation-email" data-cy="reservation-email">
                    <i class="dashicons dashicons-yes-alt"></i>
                    <i class="dashicons dashicons-warning"></i>
                    <small>Error message</small>
                </div>
                <div class="joeee-booking-reservation-form-control">
                    ...
                    <input type="text" name="reservationFirstName" placeholder="<?php esc_attr_e('First Name', 'joeee-booking')?>" id="joeee-booking-reservation-firstname" data-cy="reservation-first-name">
                    <i class="dashicons dashicons-yes-alt"></i>
                    <i class="dashicons dashicons-warning"></i>
                    <small>Error message</small>
                </div>
                <div class="joeee-booking-reservation-form-control">
                    ...
                    <input type="text" name="reservationLastName" placeholder="<?php esc_attr_e('Last Name', 'joeee-booking')?>" id="joeee-booking-reservation-lastname" data-cy="reservation-last-name">
                    <i class="dashicons dashicons-yes-alt"></i>
                    <i class="dashicons dashicons-warning"></i>
                    <small>Error message</small>
                </div>
                <div class="joeee-booking-reservation-form-control">
                    ...
                    <select name="nationalityselect" id="joeee-booking-nationality-select" data-cy="reservation-nationality">
        ...
        <div class="joeee-booking-reservation-modal-form-content-right">
            ...
            <div class="joeee-booking-reservation-form-control right">
                ...
                <select name="confirmationselect" id="joeee-booking-reservation-confirm" data-cy="reservation-confirmation">
            ...
            <div class="joeee-booking-reservation-form-control">
                ...
                <select name="genderselect" id="joeee-booking-reservation-gender" data-cy="reservation-gender">
            ...
            <div class="joeee-booking-reservation-form-control">
                ...
                <input type="date" name="reservationBirthday" placeholder="<?php esc_attr_e('Date of birth', 'joeee-booking')?>" id="joeee-booking-reservation-birthday" data-cy="reservation-birthday">
                <i class="dashicons dashicons-yes-alt"></i>
                <i class="dashicons dashicons-warning"></i>
                <small>Error message</small>
            </div>
            <div class="joeee-booking-reservation-form-control">
                ...
                <input type="text" name="reservationTIN" placeholder="<?php esc_attr_e('TIN', 'joeee-booking')?>" id="joeee-booking-reservation-tin" data-cy="reservation-tin">
                <i class="dashicons dashicons-yes-alt"></i>
                <i class="dashicons dashicons-warning"></i>
                <small>Error message</small>
            </div>
            <div class="joeee-booking-reservation-form-control">
                ...
                <input type="text" name="reservationStreet" placeholder="<?php esc_attr_e('Street/House Nr.', 'joeee-booking')?>" id="joeee-booking-reservation-street" data-cy="reservation-street">
                <i class="dashicons dashicons-yes-alt"></i>
                <i class="dashicons dashicons-warning"></i>
                <small>Error message</small>
            </div>
            <div class="joeee-booking-reservation-form-control">
                ...
                <input type="text" name="reservationZip" placeholder="<?php esc_attr_e('ZIP', 'joeee-booking')?>" id="joeee-booking-reservation-zip" data-cy="reservation-zip">
                <i class="dashicons dashicons-yes-alt"></i>
                <i class="dashicons dashicons-warning"></i>
                <small>Error message</small>
            </div>
            <div class="joeee-booking-reservation-form-control">
                ...
                <input type="text" name="reservationCity" placeholder="<?php esc_attr_e('City', 'joeee-booking')?>" id="joeee-booking-reservation-city" data-cy="reservation-city">
                <i class="dashicons dashicons-yes-alt"></i>
                <i class="dashicons dashicons-warning"></i>
                <small>Error message</small>
            </div>
            <div class="joeee-booking-reservation-form-control">
                ...
                <select name="countryselect" id="joeee-booking-country-select" data-cy="reservation-country">
            ...
            <input type="submit" value="<?php esc_attr_e('Save', 'joeee-booking')?>" id="joeee-booking-reservation-submit" class="button-submit" data-cy="reservation-submit">
            <input type="submit" value="<?php esc_attr_e('Save', 'joeee-booking')?>" id="joeee-booking-reservation-form-submit-modify" class="button-submit" data-cy="reservation-submit-modify">
            <button class="joeee-booking-reservation-cancel-btn button-cancel" data-cy="reservation-cancel-btn"><?php _e("Cancel", "joeee-booking")?></button>
            <button class="joeee-booking-reservation-delete-btn button-cancel" data-cy="reservation-delete-btn"><?php _e("Delete reservation", "joeee-booking")?></button>
            </form>
